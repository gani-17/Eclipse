...
public class excelusingdatadriven {
	...
	public void verifylogin(String uname, String password) {
	 ...
	 @DataProvider(name = "loginData")
	    public  Iterator<Object[]> provideLoginData() throws IOException {
	            ...
	            for (int j = 0; j < colCount; j++) {
	                ...
	                switch (cell.getCellType()) {
	                    case STRING:
	                        ...
	                        break;
	                    case NUMERIC:
	                        rowData[j] = String.valueOf((int) cell.getNumericCellValue()); // Convert numeric to String
	                        break;
	                    case BOOLEAN:
